...
class TestCases(unittest.TestCase):
    ...
    def test_create_rectangle_1(self):
        ...
        expected = data.Rectangle((2.0,9.0),(8.0,5.0))
    ...
    def test_create_rectangle_2(self):
        ...
        p2 = data.Point(8.0,9.0)
        expected = data.Rectangle((5.0,9.0),(8.0,4.0))
        result = hw2.create_rectangle(p1,p2)
        self.assertEqual(expected,result)
    ...
    def test_song_shorter_than(self):
        list = [data.Song("Tyler the Creator","St.Chroma",(3,17)),data.Song("ZAYN","Stardust",(3,52)),data.Song("Ariana Grande","ordinary things",(2,48))]
        limit = data.Duration(3,18)
        expected = [data.Song("Tyler the Creator","St.Chroma",(3,17)),data.Song("Ariana Grande","ordinary things",(2,48))]
        result = hw2.song_shorter_than(list,limit)
        self.assertEqual(expected,result)

    def test_song_shorter_than(self):
        list = [
            data.Song("Tyler the Creator","St.Chroma",(3,17)),
            data.Song("ZAYN","Stardust",(3,52)),
            data.Song("Ariana Grande","ordinary things",(2,48))
        ]
        limit = data.Duration(3,0)
        expected = [data.Song("Ariana Grande","ordinary things",(2,48))]
        result = hw2.song_shorter_than(list,limit)
        self.assertEqual(expected,result)
